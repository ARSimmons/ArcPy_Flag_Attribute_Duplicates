...
## different feature classes (and duplicates within
## a feature class).
## You MUST set the workspace (at the moment, this is intended to
## be a file gdb with
## the feature classes loaded in it)
## in order to begin the search.

## There are TWO hard-paths to set:
## 1) The database you are searching
## 2) The directory you'd like to export the .csv
## records of the duplicates and their count of occurance(s).

## Important: As it is set now - this script will
## error out if there is a feature class in the database
## that DOES NOT have a field called "Address".
